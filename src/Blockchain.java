...
public class Blockchain {
    ...
    public Blockchain(int difficulty) {
        ...
        Block b = new Block(0, System.currentTimeMillis(), null, null, null); // Bloco gênesis
    ...
    public Block newBlock(String voterId, String candidate) {
        Block latestBlock = latestBlock();
        return new Block(latestBlock.getIndex() + 1, System.currentTimeMillis(), latestBlock.getHash(), voterId, candidate);
    }
